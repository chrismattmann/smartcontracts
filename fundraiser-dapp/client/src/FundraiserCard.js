...
const FundraiserCard = (props) => {
  ...
  const renderDonationsList = () => {
      ...
      if (donations === null || (donations != null && donations.values == null)) {return null}
      ...
      return (
        <div className="donation-list">
          ...
          <Button variant="contained" color="primary">
              <Link className="donation-receipt-link" to="/receipts" state={ {fund: fundName, donation: donation.donationAmount, date: donation.date } }>
              Request Receipt
            </Link>
          </Button>
        </div>
  ...
  const setBeneficiary = async () => {
    ...
    return (
	    ...
	    <DialogActions>
	      <Button onClick={handleClose} variant="contained" classes={classes.button} color="primary">
	       Cancel
	      </Button>
